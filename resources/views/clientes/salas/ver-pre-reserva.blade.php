            ...
            <div class="container-fluid">
                ...
                <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
                    <div class="flex-grow-1">
                        <h4 class="fs-18 fw-semibold mb-0">Detalhes da Pré-Reserva</h4>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row align-items-start justify-content-between">
                                    <div class="col-lg-5">
                                        ...
                                        <h3 class="mb-1 text-dark fw-semibold">Pré-Reserva ID : #{{$preReserva->id}} <span class="badge bg-warning-subtle rounded-pill text-warning border border-warning fs-11 py-1 px-2 my-2">{{$preReserva->status}}</span> </h3>

                                        <div class="d-flex flex-wrap align-items-center gap-2">
                                            <p class="mb-0 fs-15">Data da Reserva : {{$preReserva->data}}</p>
                                            <div>| {{$preReserva->hora_inicio}} - {{$preReserva->hora_fim}}</div>
                                            <div>
                                                <p class="mb-0 fs-15 text-success fw-medium  d-flex align-items-center gap-1"><i class="ti ti-plane-tilt"></i>{{$preReserva->sala->unidades->nome}} | {{$preReserva->sala->nome}} </p>
                                        ...
                                        <form action="{{route('cliente-ReservarSala')}}" method="POST">
                                            @csrf 
                                            <input type="hidden" name="id_pre_reserva" value="{{$preReserva->id}}">
                                            <input type="hidden" name="id_sala" value="{{$preReserva->sala->id}}">
                                            <div class="payment-options d-flex justify-content-start gap-3">
                                                <!-- Opção Pix -->
                                                <label class="payment-option">
                                                    <input type="radio" name="payment_method" value="PIX" onclick="updatePaymentDetails('pix')" checked>
                                                    <div class="icon">
                                                ...
                                                <!-- Opção Cartão -->
                                                <label class="payment-option">
                                                    <input type="radio" name="payment_method" value="Cartão de Crédito" onclick="updatePaymentDetails('cartao')">
                                                    <div class="icon">
                                                ...
                                                <!-- Opção Próxima Fatura -->
                                                <label class="payment-option">
                                                    <input type="radio" name="payment_method" value="Próxima Fatura" onclick="updatePaymentDetails('proxima')">
                                                    <div class="icon">
                                            ...
                                            <div id="payment-details" class="mt-4">
                                                <p>Ao clicar em "Reservar", o QRCode para pagamento será exibido.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 text-end">
                                        <div class="d-flex gap-2 flex-wrap justify-content-end my-2">
                                          <!-- Botão para Submeter -->
                                        <button type="submit" class="btn btn-soft-primary">Finalizar Reserva</button>

                                        <!-- Botão para Voltar -->
                                        <a href="javascript:history.back();" class="btn btn-primary">Editar Reserva</a>
