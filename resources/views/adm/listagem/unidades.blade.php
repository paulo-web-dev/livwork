    ...
    <div class="page-container">
        ...
        <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold mb-0">Unidades Cadastrados</h4>
            </div>
                        ...
                        <table class="table table-nowrap mb-0">
                            ...
                            @foreach ($unidades as $unidade )
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="apps-ecommerce-order-details.html" class="text-muted fw-medium">#{{$unidade->id}}</a>
                                    </td>
                                    <td>
                                        <h5 class="mb-0 text-dark">{{$unidade->nome}}</h5>
                                    </td>
                                    <td>
                                        <p class="mb-1"><span class="text-dark fw-semibold">{{$unidade->telefone}}</p>
                                    </td>
                                    <td>
                                        <p class="mb-1">{{$unidade->email}}</p>
                                    ...
                                    <td class="pe-3">
                                        <div class="hstack gap-1 justify-content-end">
                                            <a href="{{route('adm-info-unidades', ['id' => $unidade->id])}}" class="btn btn-soft-primary btn-icon btn-sm rounded-circle"> <i class="ti ti-eye"></i></a>
