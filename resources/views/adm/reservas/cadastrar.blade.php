            ...
            <div class="page-container">
                ...
                <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
                    <div class="flex-grow-1">
                        <h4 class="fs-18 fw-semibold mb-0">Adicionar Reserva - Cliente: {{$cliente->nome}}</h4>
                    </div>

                   
                </div>
                
<form action="{{route('adm-reservar-sala')}}" method="post">
    @csrf
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="hidden" name="user" value="{{$cliente->id_user}}">
